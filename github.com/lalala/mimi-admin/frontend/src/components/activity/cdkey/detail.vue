    ...
    <el-col :span="16" class="contain">
      <el-form :model="form" label-width="160px" ref="form">
        ...
        <el-form-item label="活动描述:">
          <el-col :span="24">
            <span><el-tag type="gray">{{form.cdkey_desc}}</el-tag></span>
          </el-col>
        </el-form-item>
        <el-form-item label="可兑换数:">
          <el-col :span="24">
            <span><el-tag type="gray">{{form.max_exchange}}</el-tag></span>
          </el-col>
        </el-form-item>
        <el-form-item label="开始时间:">
          <el-col :span="24">
            <span><el-tag type="gray">{{new Date(form.valid_start * 1000).toLocaleString()}}</el-tag></span>
          </el-col>
        </el-form-item>
        <el-form-item label="结束时间:">
          <el-col :span="24">
            <span><el-tag type="gray">{{new Date(form.valid_end * 1000).toLocaleString()}}</el-tag></span>
          </el-col>
        </el-form-item>
        ...
        <el-form-item label="是否随机获取积分">
            <span>
              <el-tag type="gray" v-if="form.gift.credits.random_credits">是</el-tag>
              <el-tag type="gray" v-else>否</el-tag>
            </span>
        </el-form-item>
        <el-form-item label="积分随机上限(最多获取)" v-show="form.gift.credits.random_credits">
          <el-col :span="24">
            <span>
              <el-tag>{{form.gift.credits.upper_limit}}</el-tag>
            </span>
          </el-col>
        </el-form-item>
        <el-form-item label="积分随机下限(最好获取)" v-show="form.gift.credits.random_credits">
          <el-col :span="24">
            <span>
              <el-tag>{{form.gift.credits.lower_limit}}</el-tag>
            </span>
          </el-col>
        </el-form-item>
        <el-form-item label="赠送固定积分" v-show="!form.gift.credits.random_credits">
          <el-col :span="24">
            <span :sapn="24">
            <el-tag>{{form.gift.credits.credits}}</el-tag>
            </span>
          </el-col>
        </el-form-item>
        <el-form-item label="是否随机获取购彩券">
          <el-col :span="24">
            ...
            <span>
              <el-tag type="gray" v-if="form.gift.tickets.random_tickets">是</el-tag>
               <el-tag type="gray" v-else>否</el-tag>
            </span>
          </el-col>
        </el-form-item>
        <el-form-item label="购彩券随机生成上限" v-show="form.gift.tickets.random_tickets">
          <el-col :span="24">
            <span><el-tag type="gray">{{form.gift.tickets.upper_limit}}</el-tag></span>
          </el-col>
        </el-form-item>
        <el-form-item label="购彩券随机生成下限" v-show="form.gift.tickets.random_tickets">
          <el-col :span="24">
            <span><el-tag type="gray">{{form.gift.tickets.lower_limit}}</el-tag></span>
          </el-col>
        </el-form-item>
        <el-form-item label="购彩券:" v-show="form.gift.tickets.random_tickets">
          <div v-if="form.gift.tickets.tickets.length > 0" id="showTickets">
            <el-table :data="form.gift.tickets.tickets" style="width: 100%" :row-class-name="tableRowClassName">
