...
func (*Nil) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*BoolValue) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func (*IntValue) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{2} }
...
func (*StringValue) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{3} }
...
func init() { proto.RegisterFile("base.proto", fileDescriptor9) }
