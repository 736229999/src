...
func convert_z6(sch *dbproto.BuycaiScheme, zfTypeId int, ballsFormat string) zhongfu.Scheme {
...
func validate_z6(sch *apiproto.BuycaiScheme) bool {
	balls, ok := validator.CheckBalls(sch, K, 3, 10, MIN, MAX)
	if !ok {
		return false
	}
