...
func convert_zxq2(sch *dbproto.BuycaiScheme, zfTypeId int, ballsFormat string) zhongfu.Scheme {
...
func validate_zxq2(sch *apiproto.BuycaiScheme) bool {
	balls, ok := validator.CheckBalls(sch, K1, 2, 11, MIN, MAX)
	if !ok {
		return false
	}
