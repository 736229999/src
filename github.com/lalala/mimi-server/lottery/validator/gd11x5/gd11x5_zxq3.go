...
func convert_zxq3(sch *dbproto.BuycaiScheme, zfTypeId int, ballsFormat string) zhongfu.Scheme {
...
func validate_zxq3(sch *apiproto.BuycaiScheme) bool {
	balls, ok := validator.CheckBalls(sch, K1, 3, 11, MIN, MAX)
	if !ok {
		return false
	}
