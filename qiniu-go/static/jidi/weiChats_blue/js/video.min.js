			...
			var c = Object.prototype.hasOwnProperty,
				...
				o = function(a) {
					...
					if (g && a.length > 0)
						...
						for (var q in a) m && "prototype" === q || !c.call(a, q) || l.push(String(q));
					if (h)
						for (var r = n(a), s = 0; s < j.length; ++s) r && "constructor" === j[s] || !c.call(a, j[s]) || l.push(j[s]);
					return l
				};
			o.shim = function() {
				if (Object.keys) {
				...
				l = function(a) {
					...
					return g(b, a), b.prototype.createEl = function() {
						...
						return this.contentEl_ = k.createEl("div", {
							...
							innerHTML: '<span class="vjs-control-text" >' + this.localize("Stream Type") + "</span>" + this.localize("直播")+'<button class="vjs-other vjs-control vjs-button " type="button" aria-live="polite" style="display: inline-block;">123</button>'
						}, {
							"aria-live": "off"
						...
						return "disabled" !== e && h.tech_.on("timeupdate", p), Object.defineProperty(h, "default", {
							...
							get: function() {
								...
								if (o = !1, b.length !== this.activeCues_.length) o = !0;
									...
									for (var c = 0; c < b.length; c++) - 1 === this.activeCues_.indexOf(b[c]) && (o = !0);
